...
__attribute__((section("__versions"))) = {
	...
	{ 0x72b75ae3, "arpt_do_table" },
	{ 0x37a0cba, "kfree" },
	{ 0xcea10ab5, "arpt_register_table" },
	{ 0xe9458b01, "arpt_alloc_initial_table" },
	{ 0x62f09753, "arpt_unregister_table" },
	{ 0xb4390f9a, "mcount" },
};
...
MODULE_INFO(srcversion, "236004ED5BA567008F9C6E9");
